...
First, you will need to show that you know how to successfully access the Edlab environment that we will be using for our programming projects this semester. `ssh` and `sftp` are available from the command line on Mac, Linux, and Windows.
